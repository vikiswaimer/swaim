...
class ChooseLabelForAddNoteWidget extends StatefulWidget {
  const ChooseLabelForAddNoteWidget({Key? key}) : super(key: key);

  @override
  _ChooseLabelForAddNoteWidgetState createState() =>
      _ChooseLabelForAddNoteWidgetState();
}

class _ChooseLabelForAddNoteWidgetState
    extends State<ChooseLabelForAddNoteWidget> {
  @override
  void initState() {
    super.initState();
