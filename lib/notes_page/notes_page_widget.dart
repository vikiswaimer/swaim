        ...
        return Scaffold(
                                                        ...
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                ...
                                                                .override(
                                                                  fontFamily:
                                                                      'Montserrat',
                                                                  color: FFAppState().filterByLabel.contains(baseLabelsLabelsRecord
                                                                              .reference) ==
                                                                          true
                                                                      ? FlutterFlowTheme.of(
                                                                              context)
                                                        ...
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                ...
                                                                .override(
                                                                  fontFamily:
                                                                      'Montserrat',
                                                                  color: FFAppState().filterByLabel.contains(customLabelsLabelsRecord
                                                                              .reference) ==
                                                                          true
                                                                      ? FlutterFlowTheme.of(
                                                                              context)
                                                    ...
                                                    child: InkWell(
                                                      onTap: () async {
                                                        ...
                                                        if (FFAppState()
                                                          ...
                                                          setState(() => FFAppState()
                                                              .selectedSwaimsCategoriesInFilter
                                                              .add(listViewAggregationCategoriesRecord
                                                                  .reference));
                                                        }
                                                      },
                                                      child: Text(
                                                        ...
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                ...
                                                                .override(
                                                                  fontFamily:
                                                                      'Montserrat',
                                                                  color: FFAppState().selectedSwaimsCategoriesInFilter.contains(listViewAggregationCategoriesRecord
                                                                              .reference) ==
                                                                          true
                                                                      ? FlutterFlowTheme.of(
                                                                              context)
                      ...
                      onChanged: (_) => EasyDebounce.debounce(
                        ...
                        () async {
                          await queryAggregationsRecordOnce()
                              .then(
                                (records) => simpleSearchResults2 = TextSearch(
                                  records
                                      .map(
                                        (record) => TextSearchItem(
                                            record, [record.title!]),
            ...
            actions: [
              Visibility(
                ...
                child: Padding(
                  ...
                  child: ToggleIcon(
                    onPressed: () async {
                      setState(() => FFAppState().isSearchOnNotesListEnabled =
                          !FFAppState().isSearchOnNotesListEnabled);
                    },
          ...
          body: Stack(
            children: [
                                                                ...
                                                                if (containerFavoriteAggregationsRecordList
                                                                  ...
                                                                  apiResultRemoveAggregation =
                                                                      await RemoveAggregationFromFavesCall
                                                                          .call(
                                                                    favAggregationId: functions.getFavAggregationId(containerFavoriteAggregationsRecordList
                                                                        .map((e) =>
                                                                            e.reference)
                                                                        .toList()),
                                                                  );
                                                                  ...
                                                                  apiResultAddAggregation =
                                                                    ...
                                                                    aggregationId:
                                                                        functions
                                                                            .getIdFromAggregation(listViewAggregationsRecord.reference),
                                                                    userId:
                                                                        currentUserUid,
                                                                  );
                                                                }
              ...
              if (FFAppState().isSwaimsMode &&
                  (FFAppState().selectedSwaimsCategoriesInFilter.length > 0))
                Align(
                  alignment: AlignmentDirectional(0, -1),
                  child: Padding(
