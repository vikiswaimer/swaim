...
class OnboardingWelcomeCopyWidget extends StatefulWidget {
  const OnboardingWelcomeCopyWidget({Key key}) : super(key: key);

  @override
  _OnboardingWelcomeCopyWidgetState createState() =>
      _OnboardingWelcomeCopyWidgetState();
}

class _OnboardingWelcomeCopyWidgetState
    extends State<OnboardingWelcomeCopyWidget> with TickerProviderStateMixin {
  final animationsMap = {
